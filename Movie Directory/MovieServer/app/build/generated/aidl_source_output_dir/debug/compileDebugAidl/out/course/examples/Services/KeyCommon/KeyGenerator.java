...
public interface KeyGenerator extends android.os.IInterface
{
  ...
  {
    @Override public android.os.Bundle getAllMoviesInfo() throws android.os.RemoteException
    {
      return null;
    }
    @Override public java.lang.String getURL(int index) throws android.os.RemoteException
    {
      return null;
    }
    @Override public android.os.Bundle getOneMovie(int index) throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements course.examples.Services.KeyCommon.KeyGenerator
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getAllMoviesInfo:
        {
          data.enforceInterface(descriptor);
          android.os.Bundle _result = this.getAllMoviesInfo();
        ...
        case TRANSACTION_getOneMovie:
        {
          data.enforceInterface(descriptor);
          int _arg0;
          _arg0 = data.readInt();
          android.os.Bundle _result = this.getOneMovie(_arg0);
          reply.writeNoException();
          if ((_result!=null)) {
            reply.writeInt(1);
            _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
    ...
    private static class Proxy implements course.examples.Services.KeyCommon.KeyGenerator
    {
      ...
      @Override public android.os.Bundle getAllMoviesInfo() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getAllMoviesInfo, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getAllMoviesInfo();
          }
      ...
      @Override public java.lang.String getURL(int index) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getURL(index);
          }
          _reply.readException();
      ...
      @Override public android.os.Bundle getOneMovie(int index) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(index);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getOneMovie, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getOneMovie(index);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
    ...
    static final int TRANSACTION_getAllMoviesInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    static final int TRANSACTION_getURL = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
    static final int TRANSACTION_getOneMovie = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
  ...
  public android.os.Bundle getAllMoviesInfo() throws android.os.RemoteException;
  public java.lang.String getURL(int index) throws android.os.RemoteException;
  public android.os.Bundle getOneMovie(int index) throws android.os.RemoteException;
}
